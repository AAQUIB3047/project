...
for cat_data in categories:
    ...
    print(f'Category {category.category_name}: {"created" if created else "exists"}')
...
for venue_data in venues:
    ...
    print(f'Venue {venue.venue_name}: {"created" if created else "exists"}')
...
for dept_data in departments:
    ...
    print(f'Department {dept.department_name}: {"created" if created else "exists"}')
